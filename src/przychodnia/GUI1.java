...
public class GUI1 extends javax.swing.JFrame {
    ...
    final void FillList1() {
     ...
     final void FillList3() {
        ...
        try {
            ...
            DefaultListModel DLM = new DefaultListModel();
            while (rs.next()) {
                DLM.addElement(rs.getString("SPECJALIZACJA"));
            }
            jList1.setModel(DLM);
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(sprpesel3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 209, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(Dodaj)
                    .addComponent(sprpesel3, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(sprpesel2, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(Specjalizacja, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                            .addComponent(Imie1)
                            .addComponent(Nazwisko1)
                            .addComponent(Nr_telefonu1)
                            .addComponent(Pesel1)
                            .addComponent(Id_lekarza)))
                    .addComponent(sprpesel)
                    .addComponent(sprpesel1, javax.swing.GroupLayout.DEFAULT_SIZE, 209, Short.MAX_VALUE))
                .addGap(21, 21, 21))
        );
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabel4))
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                .addComponent(sprpesel1)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(sprpesel, javax.swing.GroupLayout.PREFERRED_SIZE, 33, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void DodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DodajActionPerformed
      ...
      Connection con = DriverManager.getConnection(url);
      Statement stmt = con.createStatement();
      String Query = "INSERT INTO PRZYCHODNIA(ID_PACJENTA, IMIE, NAZWISKO, PESEL, NR_TELEFONU) VALUES ('"+Id_pacjenta.getText()+"' , '"+Imie.getText()+"' , '"+Nazwisko.getText()+"' , '"+Pesel.getText()+"' , '"+Nr_telefonu.getText()+"')";
    ...
    private void Dodaj1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Dodaj1ActionPerformed
      ...
      Connection con = DriverManager.getConnection(url);
      Statement stmt = con.createStatement();
      String Query = "INSERT INTO LEKARZE(ID_LEKARZA, SPECJALIZACJA, IMIE, NAZWISKO, PESEL, NR_TELEFONU) VALUES ('"+Id_lekarza.getText()+"' , '"+Specjalizacja.getText()+"' , '"+Imie1.getText()+"' , '"+Nazwisko1.getText()+"' , '"+Pesel1.getText()+"' , '"+Nr_telefonu1.getText()+"')";
